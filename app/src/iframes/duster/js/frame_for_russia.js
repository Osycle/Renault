...
new Vue({
  el: '#app',
  watch: {
    /*forRussiaActiveSlide(){
        if(this.forRussiaActiveSlide === 0){
            ga('send', 'event', 'click', 'duster-suv-platform', 'Интеллектуальная система полного привода All-Mode 4x4i')
            console.log('ga(\'send\', \'event\', \'click\', \'duster-suv-platform\', \'Интеллектуальная система полного привода All-Mode 4x4i\')')
        } else if( this.forRussiaActiveSlide === 1){
            ga('send', 'event', 'click', 'duster-suv-platform', 'Рулевой механизм с электроусилителем')
            console.log('ga(\'send\', \'event\', \'click\', \'duster-suv-platform\', \'Рулевой механизм с электроусилителем\')')
        }
    },*/
  },
  data: {
    ...
    activeNewOption: 0,
    newOptions: [{
      icon: 'img/newOptions/icon_1.png',
      name: 'Обогрев<br> руля',
      text: '',
      image: 'img/comfort/steering-wheel.jpg'
    }, {
      icon: 'img/newOptions/icon_2.png',
      name: 'Подогрев передних и&nbsp;задних сидений',
      text: '',
      image: 'img/comfort/sittings.jpg'
    }, {
      icon: 'img/newOptions/icon_3.png',
      name: 'Электрообогрев лобо- вого стекла и форсунок омывателя',
      text: '',
      image: 'img/comfort/windshield.jpg'
    }, {
      icon: 'img/newOptions/icon_4.png',
